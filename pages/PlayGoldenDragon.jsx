      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <GoldenDragonSlot wallet={wallet} onBet={handleBet} currency={currency} />
          </div>
