...
import CactusCassidySlot from '@/components/slots/CactusCassidySlot';
import WalletDisplay from '@/components/casino/WalletDisplay';

export default function PlayCactusCassidy() {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <CactusCassidySlot wallet={wallet} onBet={handleBet} currency={currency} />
          </div>
